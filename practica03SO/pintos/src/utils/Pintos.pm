...
#   LOADER => $LOADER_SIZE-byte string containing the /pintos-2020-2/src/threads/build/loader.binary
#   ARGS => ['arg 1', 'arg 2', ...]
sub assemble_disk {
    my (%args) = @_;
...
sub read_loader {
    my ($name) = @_;
    $name = find_file ("/pintos-2020-2/src/threads/build/loader.bin") if !defined $name;
